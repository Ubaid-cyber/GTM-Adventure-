...
"[project]/frontend/src/app/api/bookings/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
      ...
      `;
        ...
        if (error.message === 'NOT_ENOUGH_SPOTS') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Sorry, not enough spots available for this trek.'
            }, {
                status: 400
            });
        }
...
async function GET(req) {
    try {
        ...
        const bookings = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].booking.findMany({
            where: {
                userId: user.id
            },
            include: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0ed04c2d._.js.map
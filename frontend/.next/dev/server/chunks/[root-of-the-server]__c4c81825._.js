...
"[project]/frontend/src/app/api/user/medical/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(user.medicalProfile || {});
    } catch (error) {
...
async function POST(req) {
    try {
        ...
        const oldHistory = user.medicalProfile?.history || {};
        const newHistory = history || {};
        // Check if any NEW risk factor was added (transition from false/null/undefined to true)
        const riskAdded = Object.keys(newHistory).some((key)=>newHistory[key] === true && oldHistory[key] !== true);
        const currentStatus = user.medicalProfile?.status || 'NONE';
        let nextStatus = currentStatus;
        if (currentStatus === 'NONE' || riskAdded) {
            nextStatus = 'AWAITING_CLEARANCE';
        }
        const medicalProfile = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].medicalProfile.upsert({
            where: {
                userId: user.id
            },
            update: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c4c81825._.js.map
...
"[project]/frontend/src/app/api/cron/release-spots/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const dynamic = 'force-dynamic'; // Ensure Next.js doesn't cache this cron job
async function GET(req) {
    try {
        ...
        const expiredBookings = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].booking.findMany({
            where: {
                status: 'PENDING',
                createdAt: {
                    lt: tenMinutesAgo
        ...
        for (const booking of expiredBookings){
            await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(async (tx)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b88dedca._.js.map
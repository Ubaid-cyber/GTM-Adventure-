...
"[project]/frontend/src/app/api/razorpay/verify/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (razorpay_order_id.startsWith('mock_') && razorpay_signature === 'mock_sig') {
            ...
            // Verify signature
            const shasum = __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].createHmac('sha256', secret);
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].booking.update({
            where: {
                id: bookingId
            },
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9c7d9f9c._.js.map
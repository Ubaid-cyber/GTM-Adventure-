...
import { updateMedicalProfileAction } from '@/lib/actions/health-actions';
...
export default function HealthClient({ 
  ...
  const [profile, setProfile] = useState<MedicalProfile | null>(initialProfile);
  ...
  const [showOther, setShowOther] = useState(!!initialProfile?.history?.other);

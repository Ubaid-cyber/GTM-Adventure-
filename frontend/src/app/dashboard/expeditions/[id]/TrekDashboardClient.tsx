    ...
    return (
      <div className="min-h-screen bg-[#050505] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-primary font-mono text-sm tracking-widest uppercase animate-pulse">Loading Trek Data...</p>
        </div>
      </div>
    );
  }
  ...
  if (error || !data) {
    return (
      <div className="min-h-screen bg-[#050505] pt-32 pb-20 flex flex-col items-center justify-center px-4">
        <h1 className="text-2xl font-bold text-red-500 mb-4">Data Unavailable</h1>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
          <div className="space-y-2">
            <div className="flex items-center gap-3">
              ...
              <span className="text-primary/50 font-mono text-xs">LIVE_DASHBOARD_ACTIVE</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-black tracking-tight">{data.trek.title}</h1>
            <p className="text-muted text-sm font-medium opacity-60">Group Trek // Status for {data.trek.durationDays} Days</p>
          </div>
              ...
              {activeTab === 'progress' && (
                ...
                >
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-md relative overflow-hidden group">
                    <div className="absolute top-0 right-0 p-4 font-mono text-[10px] text-white/20">TRACKING_ID: X-992</div>
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-md">
                     ...
                     <div className="space-y-3 font-mono text-[11px] text-white/60">
                       <div className="flex gap-4"><span className="text-primary">00:00:23</span> <span>System started... Connecting to satellite</span></div>
                       <div className="flex gap-4"><span className="text-primary">00:01:05</span> <span>Signal strength: 98.4%</span></div>
                       <div className="flex gap-4"><span className="text-primary">00:02:11</span> <span className="text-emerald-400 italic">Location update: Namche Bazaar check-point cleared.</span></div>
                       <div className="flex gap-4 animate-pulse"><span className="text-primary">00:05:12</span> <span className="text-white">Waiting for next update...</span></div>
                     </div>
                  </div>
                </motion.div>
              )}

              ...
              <div className="relative z-10 space-y-10">
                 ...
                 <div className="space-y-4">
                    {[
                      ...
                      { id: 'MEDICAL', label: 'Health Clearances', icon: Heart },
                      { id: 'ASSETS', label: 'Asset Overview', icon: Clipboard },
                      { id: 'LOGS', label: 'Log Records', icon: Activity }
                    ].map((tool, i) => (
                      <button 
                        key={i} 
                        onClick={() => tool.id === 'MEDICAL' ? setActiveView('MEDICAL') : null}

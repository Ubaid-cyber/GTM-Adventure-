    ...
    <div className="space-y-8 animate-in fade-in duration-700 text-left">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-white/40 text-sm mt-1">A complete record of all dashboard activities.</p>
        </div>
        <div className="flex items-center gap-3 px-4 py-2 bg-white/5 border border-white/5 rounded-xl shadow-lg">
           <Terminal className="w-4 h-4 text-blue-500" />
           <span className="text-white/70 text-sm font-mono tracking-tight">System Secure</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white/[0.02] border border-white/5 rounded-2xl p-5 shadow-xl relative overflow-hidden group">
           <div className="text-[10px] font-black uppercase tracking-widest text-white/30 mb-1">Admin Locations</div>
